...
func main() {
      ...
      if argsNum < 2 { 
		fmt.Println("Primestring Usage: \n")
                ...
                fmt.Println("prime bitstring buffer 0110111011111011111110111111111110111111111111101111111111111111101111111111111111111011111111111111111111111011111111111111111111111111111011111111111111111111111111111110")
                fmt.Println("prime bitstring bigint 2595260104894187739584209022383644315017711787704318" )
		os.Exit(1)
      }
